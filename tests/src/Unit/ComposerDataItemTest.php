...
use Drupal\helfi_debug\Plugin\DebugDataItem\Composer;
use Drupal\Tests\UnitTestCase;

/**
 * Tests Composer plugin.
 *
 * @coversDefaultClass \Drupal\helfi_debug\Plugin\DebugDataItem\Composer
 * @group helfi_debug
 */
class ComposerDataItemTest extends UnitTestCase {
  ...
  private function getContainer(array $packages) : ContainerBuilder {
    ...
    $container->set('helfi_debug.composer_info', $composerInfo->reveal());
    return $container;
  }
